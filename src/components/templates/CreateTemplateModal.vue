...
const copy = computed(() => {
  switch (locale.value) {
    ...
    case 'es':
      return {
        modalTitle: 'Crear Nuevo Template',
        modalDescription: 'Elige una página, organiza los metadatos del template y publica una versión más clara de tu diseño.',
        basicSection: 'Página Base',
        basicSectionHint: 'La página seleccionada define el snapshot visual, los bloques y los audios guardados en este template.',
        pageLabel: 'Página',
        pagePlaceholder: 'Selecciona la página',
        pageHint: 'Elige qué página será la base del nuevo template.',
        pageRequired: 'Selecciona una página antes de crear el template.',
        templateName: 'Nombre del Template',
        templateNamePlaceholder: 'Ej: Portfolio oscuro',
        previewSection: 'Imagen de Preview',
        previewSectionHint: 'Usa una portada que represente el resultado visual del template.',
        ...
        tagHint: 'Los templates usan un catálogo controlado de tags para evitar filtros gigantes.',
        ...
        previewRequired: 'Por favor, selecciona una imagen de preview.',
        atLeastOneTag: 'Agrega al menos una tag.',
        loadingToast: 'Creando tu nuevo template...',
        successToast: (name: string) => `Template "${name}" creado con éxito!`,
        errorToast: 'Ocurrió un error al crear el template.',
      };
    default:
      return {
        modalTitle: 'Criar Novo Template',
        modalDescription: 'Escolha uma página, organize os metadados do template e publique uma versão mais clara do seu design.',
        basicSection: 'Página Base',
        basicSectionHint: 'A página selecionada define o snapshot visual, os blocos e os áudios salvos neste template.',
        pageLabel: 'Página',
        pagePlaceholder: 'Selecione a página',
        pageHint: 'Escolha qual página deve ser usada como base do novo template.',
        pageRequired: 'Selecione uma página antes de criar o template.',
        templateName: 'Nome do Template',
        templateNamePlaceholder: 'Ex: Portfolio escuro',
        previewSection: 'Imagem de Preview',
        previewSectionHint: 'Use uma capa que represente bem o resultado visual do template.',
        ...
        tagHint: 'Templates usam um catálogo controlado de tags para evitar filtros gigantes.',
        ...
        previewRequired: 'Por favor, selecione uma imagem de preview.',
        atLeastOneTag: 'Adicione pelo menos uma tag.',
        loadingToast: 'Criando seu novo template...',
        successToast: (name: string) => `Template "${name}" criado com sucesso!`,
        errorToast: 'Ocorreu um erro ao criar o template.',
      };
  }
});
