        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div class="space-y-2">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-4xl font-bold text-white tracking-tight">{{ copy.title }}</h1>
                </div>
                <p class="text-slate-400 text-lg">{{ copy.subtitle }}</p>
            </div>
            <button @click="$emit('save')" :disabled="isSaving"
                class="ui-btn-primary flex-shrink-0">
                <span v-if="!isSaving">{{ copy.saveChanges }}</span>
...
const copy = computed(() => {
    switch (locale.value) {
        case 'en':
            return {
                title: 'Appearance',
                subtitle: 'Customize your profile and create a unique experience.',
        ...
        case 'es':
            return {
                title: 'Apariencia',
                subtitle: 'Personaliza tu perfil y crea una experiencia única.',
        ...
        default:
            return {
                title: 'Aparência',
                subtitle: 'Personalize seu perfil e crie uma experiência única.',
