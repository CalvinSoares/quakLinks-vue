  ...
  switch (locale.value) {
    case "en":
      return {
        ...
        blur: "Blur",
        filter: "Filter",
        filters: { none: "None", normal: "Normal", noise: "Noise", scanlines: "Scanlines", vignette: "Vignette" },
    ...
    case "es":
      return {
        pageLayout: "Diseno de la Pagina",
        ...
        blur: "Desenfoque",
        filter: "Filtro",
        filters: { none: "Ninguno", normal: "Normal", noise: "Ruido", scanlines: "Lineas", vignette: "Viñeta" },
        uploadVideo: "Subir video (MP4)",
        backgroundVideoLocked: "El video de fondo está disponible en el plan PREMIUM.",
        profileCard: "Tarjeta de Fondo del Perfil",
    ...
    default:
      return {
        pageLayout: "Estrutura da Pagina",
        ...
        blur: "Desfoque",
        filter: "Filtro",
        filters: { none: "Nenhum", normal: "Normal", noise: "Ruido", scanlines: "Linhas", vignette: "Vinheta" },
        uploadVideo: "Enviar video (MP4)",
        backgroundVideoLocked: "Vídeo de fundo está disponível no plano PREMIUM.",
        profileCard: "Cartao de Fundo do Perfil",
        cardColor: "Cor do Cartao",
        opacity: "Opacidade",
...
const standardOverlayOptions = computed(() => [
  ...
  { label: copy.value.filters.scanlines, value: "scanlines" },
