...
const copy = computed(() => {
  switch (locale.value) {
    ...
    case "es":
      return {
        emptyExplore: "No se encontraron templates.",
        emptyMine: "Aún no has creado ningún template.",
        applyLoading: "Aplicando template...",
        applySuccess: "¡Template aplicado con éxito!",
        applyError: "Error al aplicar el template.",
        deleteConfirm: "¿Seguro que deseas eliminar este template? Esta acción no se puede deshacer.",
        deleteModalTitle: "Eliminar template",
        deleteLoading: "Eliminando template...",
        deleteSuccess: "Template eliminado con éxito.",
        cancel: "Cancelar",
        confirmDelete: "Eliminar template",
        deleteError: "Error al eliminar el template.",
        linkCopied: "¡Enlace del template copiado!",
        linkCopyError: "Error al copiar el enlace del template.",
      };
    default:
      return {
        emptyExplore: "Nenhum template encontrado.",
        emptyMine: "Você ainda não criou nenhum template.",
        applyLoading: "Aplicando template...",
        applySuccess: "Template aplicado com sucesso!",
        applyError: "Falha ao aplicar o template.",
        deleteConfirm: "Tem certeza que deseja excluir este template? Esta ação não pode ser desfeita.",
        deleteModalTitle: "Excluir template",
        deleteLoading: "Excluindo template...",
        deleteSuccess: "Template excluído com sucesso.",
        cancel: "Cancelar",
        confirmDelete: "Excluir template",
        deleteError: "Falha ao excluir o template.",
        linkCopied: "Link do template copiado!",
        linkCopyError: "Falha ao copiar o link do template.",
      };
  }
});
